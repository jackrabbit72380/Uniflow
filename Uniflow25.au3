...
;Theme GUI Stageone
Global $Stageone = AddBillboardSceneNode($Camera,1280, 720)
...
SetMaterialType($stageone,14) ;EMT_TRANSPARENT_ALPHA_CHANNEL_REF
...
;Theme GUI Banner
Global $banner = AddBillboardSceneNode($Camera,1280, 720)
;Global $banner = AddBillboardSceneNode($Camera,1290, 720)
setPosition($banner,0+IniRead($IniTheme, "GUI", "Banner-X", ""),0+IniRead($IniTheme, "GUI", "Banner-Y", ""),-498)
...
;Global $blueline = AddBillboardSceneNode($Camera, 1280, 720)
setPosition($blueline,0+IniRead($IniTheme, "GUI", "Blueline-X", ""),0+IniRead($IniTheme, "GUI", "Blueline-Y", ""), -498)
