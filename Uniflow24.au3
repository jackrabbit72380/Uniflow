...
_GUICtrlPic_SetImage($FlowmodeButton, $TempFolder & "\flowmode.png")
GUICtrlSetCursor(-1, 0)
...
setPosition($pannelright,0+IniRead($IniTheme, "GUI", "Pannelright-X", ""),0+IniRead($IniTheme, "GUI", "Pannelright-Y", ""),-493)
...
setPosition($pannelleft,0+IniRead($IniTheme, "GUI", "Pannelleft-X", ""),0+IniRead($IniTheme, "GUI", "Pannelleft-Y", ""),-492)
